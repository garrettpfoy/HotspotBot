...
while(True):
  ...
  if(assetNumber.upper() == "EXIT" or hotspotAsset.upper() == "EXIT"):
  ...
  try:
      ...
      try:
          ...
          try:
              ...
              try:
                  driver.implicitly_wait(IMPLICIT_WAIT)
                  newNewNewApplyBox = driver.element_by_xpath("/html/body/div/section/section/main/div[2]/div[2]/div/form/div[5]/div/button[1]/span")
  ...
  print(" ")
  print("Success! The script has completed!")
  print("Want to run again? Simply follow the instructions below!")
  print("Want to exit? Enter 'exit' instead of scanning.")
  print(" ")
  print("NOTE: If you recieve an ERR_CONN_RESET error")
